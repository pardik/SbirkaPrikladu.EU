...
var _wrs_conf_getmathmlPath = CKEDITOR.basePath + '/plugins/ckeditor_wiris/integration/getmathml.aspx';			// Specifies where is the getmathml script.
var _wrs_conf_servicePath = CKEDITOR.basePath + '/plugins/ckeditor_wiris/integration/service.aspx';			// Specifies where is the service script.
	...
	'init': function (editor) {
		...
		if (_wrs_conf_editorEnabled) {
			...
			editor.ui.addButton('ckeditor_wiris_formulaEditor', {
			    'label': 'Editor matematickych vzorcu',
