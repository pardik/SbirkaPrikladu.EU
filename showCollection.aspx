                ...
                <asp:Repeater ID="examplesRPT" DataSourceID="SqlDataSource1" runat="server">
                    <ItemTemplate>
                        <div class="row">
                            <div class="span9">
                                <div class="pgH well">
                                    <a href='/p/<%# Eval("id") %>'><h2 class="label label-inverse"><%# Eval("position") %>.&nbsp;<%# hideExamplesHeaders? "" : Eval("name") %></h2></a><br />                            
