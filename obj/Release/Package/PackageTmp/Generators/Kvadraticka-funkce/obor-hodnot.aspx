<%@ Page Title="" Language="C#" MasterPageFile="~/withSideBar.Master" AutoEventWireup="true" CodeBehind="obor-hodnot.aspx.cs" Inherits="SbirkaPrikladuEU.Generators.Kvadraticka_funkce.obor_hodnot" %>
    ...
    <div class="row">        
        <div class="span9">
            <div class="pgH well geogebraAppletContainer">
                ...
                <iframe scrolling="no" src="https://www.geogebratube.org/material/iframe/id/100288/width/widthToReplace/height/500/border/888888/rc/false/ai/false/sdz/true/smb/false/stb/false/stbh/true/ld/false/sri/true/at/preferhtml5" width="830px" height="500px" style="border:0px;"></iframe>
                <script>
