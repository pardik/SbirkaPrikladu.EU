<%@ Page Title="" Language="C#" MasterPageFile="~/withSideBar.Master" AutoEventWireup="true" CodeBehind="rotace.aspx.cs" Inherits="SbirkaPrikladuEU.Generators.Shodna_zobrazeni.rotace" %>
        ...
        <div class="span9">
            <div class="pgH well geogebraAppletContainer">
                <div class="page-header">
                  <h1>Rotace <small class="pull-right">Generátor příkladů</small></h1>
                </div>
                <iframe scrolling="no" src="https://www.geogebratube.org/material/iframe/id/100371/width/widthToReplace/height/500/border/888888/rc/false/ai/false/sdz/true/smb/false/stb/false/stbh/true/ld/false/sri/true/at/preferhtml5" width="830px" height="500px" style="border:0px;"></iframe>
                <script>
